...
const addBtn = document.querySelector("#addDocBtn");
const formBox = document.querySelector("#addDocForm");
const overlay = document.querySelector("#overlay");
const form = document.querySelector("#docForm");
const docNameInput = document.querySelector("#docName");
const tableBody = document.querySelector("#docTableBody");
const search = document.querySelector("#search");
const pendingWrapper = document.querySelector("#pendingCountWrapper");
const pendingCountInput = document.querySelector("#pendingCount");
...
search.addEventListener("input", () => {
    ...
    const filteredDocs = docs.filter(doc => doc.name.toLowerCase().includes(query));
